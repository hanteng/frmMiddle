...
try:
    ...
    #         'loc_en': '英文名',  
    d_compact_cols = { 'emojiflag': '旗', 'loc_zht': '中文名', 
        'type': '🗳政治體制', 'middlep':'權力區',
    ...
    styled_tableA = (
        df_compact[['權力區', '🗳政治體制', '旗','中文名', '🌐APEC','🌐G20','🌐OECD','ISO2', 'ISO3']].style
        .set_table_attributes('class="dataframe table table-striped table-hover"') 
        .set_caption("全球中等強權表〜🗳政治體制與國際組織")
        .to_html()
    )
    styled_tableB = (
        df_compact[['權力區', '🗳政治體制', '旗','中文名','◉地域涵括表','⦿地域涵括表','ISO2', 'ISO3']].style
        .set_table_attributes('class="dataframe table table-striped table-hover"') 
        .set_caption("全球中等強權表〜🗳政治體制與地域涵括表")
        .to_html()
    )
    #df_compact
    display(HTML(styled_tableA))
    display(HTML(styled_tableB))
