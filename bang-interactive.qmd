...
const MIDDLE_POWERS = {
  ...
  "FRA": { label: "🇫🇷 法國 (France)", name: "France", lat: 46.23, lon: 15.72, color: 0x2c7bb6, closeDistF: 1.45, type: "完全民主", middlep: "⏫中上" },
...
// Ensure globeMesh is declared globally: let globeMesh;
...
async function init() {
    ...
    const globeMesh = await createGlobeMaterial(); // Await ensures renderer is available
