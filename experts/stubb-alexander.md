...
categories:
  ...
  - 新世界秩序
  - 基於價值的現實主義
description: 芬蘭總統**亞歷山大·史塔布**是「**基於價值的現實主義**」外交政策的倡導者。他強調歐洲的「**歷史假期已經結束**」，並推動芬蘭加入北約，以實力（Power）應對俄羅斯的威脅。其 EUI 講座系列《新世界（失）秩序》（The New World (Dis)Order）將出版。
tags:
  - 🇫🇮芬蘭
  - 🔑中關強權
  - 歐洲安全 
...
- 📖 **書籍與系列框架**
    - 📘 **研究核心**： 探討全球權力轉移、西方與東方（中、俄）的競爭，以及**全球南方**（Global South）在塑造新秩序中的決定性作用。
    - 🧩 **三大分析層面：** 旨在提供對複雜全球力量的全面理解：
        - 1️⃣ **權力的秩序** （The Order of Power）
        - 2️⃣ **權力的平衡** （The Balance of Power）
        - 3️⃣ **權力的動力** （The Dynamics of Power）
- 📅 **從冷戰結束到烏克蘭戰爭**（Disorder to Disruption）
    - 📉 **從秩序到混亂**： 分析從 1989 年冷戰結束後的單極時刻，到當前以烏克蘭戰爭為標誌的混亂與動盪。        
    - 📞 **個人的時刻（EP 2）**： 分享他在俄羅斯入侵烏克蘭後，與俄羅斯外交部長拉夫羅夫（Sergey Lavrov）的簡訊交流，強調外交的迅速終結。
    - 🌍 **全球反應（EP 4）**： 剖析俄烏戰爭爆發後，**全球西方**、**全球東方**和**全球南方**三股勢力的不同反應與後續影響。        
    - 🤝 **多邊失序（EP 5）**： 探討當前多邊機構（Multilateral Institutions）所面臨的複雜挑戰和「失序」狀態。
